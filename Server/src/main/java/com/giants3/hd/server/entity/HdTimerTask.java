...
import com.giants3.hd.server.controller.TaskController;
...
public class HdTimerTask extends TimerTask{
    ...
    public HdTimerTask(HdTask hdTask, PlatformTransactionManager transactionManager, MaterialController materialController, TaskLogRepository taskLogRepository, List<HdTimerTask> taskList, TaskRepository taskRepository, Timer timer)
    {
       this.hdTask=hdTask;
...
// explicitly setting the transaction name is something that can only be done programmatically
      ...
      long spendTime=   (System.currentTimeMillis()-startTime)/1000;
        ...
        if(hdTask.repeatCount>hdTask.executeCount)
        {
            ...
            HdTimerTask hdTimerTask=new HdTimerTask(hdTask,transactionManager,materialController,taskLogRepository,taskList,taskRepository,timer);
