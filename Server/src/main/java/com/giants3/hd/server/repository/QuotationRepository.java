...
public interface QuotationRepository extends JpaRepository<Quotation,Long> {
   ...
   Page<Quotation> findByCustomerNameLikeAndSalesmanIdInOrQNumberLikeAndSalesmanIdEqualsOrderByQDateDesc(String customerName, long[] salesManIds, String qNumber, long salesManId2, Pageable pageable);
