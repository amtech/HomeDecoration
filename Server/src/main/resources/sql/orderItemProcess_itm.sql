...
SELECT   a.MO_DD as moDd,	a.MO_NO as moNo,	a.STA_DD as staDd,	a.END_DD as endDd	,a.SO_NO AS osNo	,a.EST_ITM as ITM , 	a.MRP_NO as mrpNo,	a.MO_NO_ADD AS prdNo,a.id_no as idNo,	a.QTY,b.jgh,b.scsx
