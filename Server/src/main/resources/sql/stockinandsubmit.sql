--外厂进库 ||--车间缴库 单
 select * from (
		 ...
		 select  mm_no as no,SO_NO ,itm ,PRD_NO,PRD_NAME,PRD_MARK  ,BAT_NO,CUS_OS_NO,QTY ,mm_dd as dd   ,1 as type , ID_NO ,'' as dept from TF_MM0 where wh= UPPER ('CP')    and mm_dd  >= :startDate  and mm_dd  <= :endDate
