 ...
 *  业务员表格数据模型
 */
public class OrderAuthModel extends  BaseTableModel<OrderAuth> {
    ...
    @Inject
    public OrderAuthModel() {
        super(columnNames, fieldName, classes, OrderAuth.class);
    }
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        OrderAuth authority=getItem(rowIndex);
