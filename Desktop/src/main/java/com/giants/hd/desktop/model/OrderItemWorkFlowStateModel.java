...
public class OrderItemWorkFlowStateModel extends  BaseTableModel<OrderItemWorkFlowState> {
    ...
    public static String[] columnNames = new String[]{     "订单号 ",  "产品号" ,"订单数量" ,"当前流程" ,"当前数量","创建时间","错误信息" };
    public static int[] columnWidth=new int[]{   150,        150 ,150, 120,200};


    public static final String TIME_SPEND = "timeSpend";
    public static String[] fieldName = new String[]{ "orderName", "", "orderQty","workFlowName", "qty","createTimeString","memo"  };
