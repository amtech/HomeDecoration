...
public class ZhilingdanModel extends BaseTableModel<Zhilingdan> {
    ...
    public static String[] columnNames = new String[]{"单号 ", "日期", "订单号", "品号", "品名"," prd_mark ", "定制数量", "采购单号",  "采购数量", "采购日期","采购前置期", "进货单号","进货数量", "进货日期", "进货前置期", };
    public static int[] columnWidth = new int[]{120, 100, 120, 100,100, 80,80, 80,100, 100, 80, 100,100, 60, 60};
    ...
    public static String[] fieldName = new String[]{"mo_no", "mo_dd", "os_no", "prd_no","prd_name",  "prd_mark", "qty_rsv", CAIGOU_NO, CAIGOU_QTY, CAIGOU_DD, NEED_DD, JINHUO_NO, JINHUO_QTY, JINHUO_DD, NEED_DAYS};
