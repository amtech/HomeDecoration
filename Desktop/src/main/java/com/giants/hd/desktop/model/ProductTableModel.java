...
public class ProductTableModel extends BaseTableModel<Product> {
    ...
    public static String[] fieldName = new String[]{"photo", "name",  "pVersion","pack",COLUMN_SPEC,"pUnitName", "pClassName", "rDate",COLUMN_SHOW_COST,"factoryCode","factoryName","memo"};
