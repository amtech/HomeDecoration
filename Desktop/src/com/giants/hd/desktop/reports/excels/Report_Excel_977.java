 ...
 */
public class Report_Excel_977 extends ExcelReportor {


    public Report_Excel_977(QuotationFile modelName) throws HdException {
        super(modelName);

        throw   HdException.create("977 报价 未完成");
    }
