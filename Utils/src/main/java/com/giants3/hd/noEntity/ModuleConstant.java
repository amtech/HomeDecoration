 ...
 * <p/>
 * <p/>
 * //添加进货缴库单 销库单  2016/11/19.
 * 进货单里的数据是外厂到仓库的信息，缴库单的数据是车间到仓库的信息，
 * 销库单 的数据是仓库到装柜的信息
 */
public class ModuleConstant {
    ...
    public static final String TITLE_STOCK_OUT = "出库列表";
    ...
    public static final String TITLE_STOCK_IN_AND_SUBMIT = "进货与缴库";
    public static final String NAME_STOCK_IN_AND_SUBMIT = "stockInAndSubmit";


    public static final String TITLE_TRANSPORT_OUT = "销库单";
    public static final String NAME_TRANSPORT_OUT = "transportOut";
    ...
    public static final String TITLE_OUT_FACTORY = "加工户数据";
    public static final String NAME_OUT_FACTORY  = "OutFactory";


    public static final String TITLE_PRODUCT_ARRANGE_TYPE = "产品排厂类型";
    ...
    public static final String TITLE_APP_QUOTATION_REPORT = "广交会报价报表";
    public static final String NAME_APP_QUOTATION_REPORT = "APP_QUOTATION_REPORT";
